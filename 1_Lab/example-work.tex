...
асимптотическая сложность добавления элемента в него равна $ O(\log n) $. Тогда $ T(\textit{reflexiveClosure}, n)
= O(n\log n) $.
...
сложность с учётом стоимости вставки элемента: $ O(n_1\log n) $. Тогда число элементарных операций для $ n $ 
элементов будет составлять: $$ \log n\sum\limits_{i=1}^{n} n_i \leq n^2 \log n \implies 
...
Определим $ n $ как число уникальных элементов, встречающихся в бинарном отношении, $ n_i $ как число 
